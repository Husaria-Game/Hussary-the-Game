...
public class MouseOverFactionForAIPlayer : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    public ChooseFactionForAIPlayer CFS;
    public Image imageThis;
    public MouseOverFactionForAIPlayer imageOther;
