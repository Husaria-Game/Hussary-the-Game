...
public class MouseOverFactionForSecondPlayer : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    public ChooseFactionForSecondPlayer CFS;
    public Image imageThis;
    public MouseOverFactionForSecondPlayer imageOther;
