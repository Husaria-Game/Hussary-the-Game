...
public class MouseOverFaction2 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    public ChooseFactionScript2 CFS;
    public Image imageThis;
    public MouseOverFaction2 imageOther;
